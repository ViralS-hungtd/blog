...
@if(isset($field['value']))
    <label for="imgInp" class="cursor">
        <img id="blah" src="{{ asset($field['value']) }}" class="img-responsive" style="max-width: 200px" />
    </label>
@else
    <label for="imgInp" class="cursor">
        <img id="blah" src="{{ asset('images/user-no-image.svg') }}" class="img-responsive" style="max-width: 200px" />
    </label>
@endif
