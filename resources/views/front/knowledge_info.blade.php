@extends('front.app')
@section('title', 'Hiểu về không gian mạng')
@section('meta')
<meta property="og:image" content="{{ asset('assets/images/image-02.png') }}" />
@endsection
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row knowleadge-box">
                            ...
                            <div class="col-sm-12">
                                <p class="text-15px text-cyber-bold"><b>Cảnh báo tính năng đăng nhập và bảo vệ 2 lớp</b></p>
                            ...
                            <div class="col-sm-12">
                                <p class="text-15px text-cyber-bold"><b>Đăng nhập an toàn</b></p>
                    ...
                    <div class="row knowleadge-box">
                        <div class="col-sm-7" style="margin-top: auto; margin-bottom:auto;">
                            <p class="cyber-title behind-yellow">
                                <span>NGUY CƠ KẾT BẠN KHÔNG PHÙ HỢP</span>
                            </p>
